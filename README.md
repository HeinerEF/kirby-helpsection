...
It may be, that you have to make changes in the blueprint file "`site/blueprints/site.yml`" to show the **unlisted** page "**/helpsection**" at the dashboard (start page) of the Panel, e.g. if you have started with the Kirby-Starterkit (https://github.com/getkirby/starterkit).
